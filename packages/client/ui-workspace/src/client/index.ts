...
export type {
  ...
  MenuOpenState, RowToast, SessionActionOwnerProps, SessionRenameTarget, SessionRowOwnerProps, UseMenuOpenState,
  ...
  ctx.slots.inject('sidebar.workspaces', () => ctx.slots.register(
    {
      ...
      children: {
        ...
        'sidebar.workspaces.sessionAction': { kind: 'list', scope: 'root' },
