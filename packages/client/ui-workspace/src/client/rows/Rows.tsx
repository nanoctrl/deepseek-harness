...
import type { MenuOpenState, SessionActionOwnerProps, WorkspaceBrowserProps } from '../contract/slots.ts'
 ...
 * @param props.renderSessionActions - render slot-provided session actions pinned in the row menu footer.
...
export function SessionNodeItem({
  node, currentId, now, onOpen, onRenameRequest, renderSlot, onReveal, renderSessionActions, drag, flat = false, t,
}: {
  node: SessionNode
  currentId: string | undefined
  now: number
