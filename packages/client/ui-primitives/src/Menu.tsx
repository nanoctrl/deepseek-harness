 ...
 */
export function Menu({ open, anchor, items = [], children, selectedId, selectedIds, onSelect, onClose, align = 'start', side = 'bottom', portal = false, closeOnPointerLeave = false, dense = false, compact = false, autoFocus = false, selection = 'check', getAnchorRect, footer, footerNode, className, listClassName }: {
  open: boolean
  autoFocus?: boolean
  anchor: ReactNode
