...
- [Sidebar state and activity indicators](2026-08-31-sidebar-state-and-activity-indicators.md) — owns the current row rendering; every session now shows a state dot.
